...
|----|----------|------------------------|---------|
| A1 | Is the purpose of STudyConnect clearly explained?||
| A2 | Does the introductory text explain why the softare is needed?||
| A3 | Is the introductory text structured logically?||
| A4 | Are target users identified?||
| A5 | Does the the introduction include an overview of what the StudyConnect app shall do?||
